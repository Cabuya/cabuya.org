...
| [`audit-analytics`](../skills/audit-analytics/SKILL.md) | sonnet | 2 | Audit Umami analytics wiring — EVENTS catalog vs docs vs components, privacy lint, proxy config. Use proactively before releases or when adding trackEvent calls. |
