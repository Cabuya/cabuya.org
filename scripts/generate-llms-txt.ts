...
function buildIndex(): string {
  ...
  const lines = [
    ...
    '',
    `The specification is at version ${version}, status draft. Nothing in it is`,
    'normative yet, and every artefact says so. This file is generated from the',
...
function buildFull(): string {
  ...
  const lines = [
    ...
    '',
    `Specification ${version} (draft), the consumption rules, and every`,
