...
- **Dev (direct URL):** Accessible by direct URL (e.g., `http://localhost:7777/blog/demo-hero-banner/`)
...
- English: `http://localhost:7777/blog/{slug}/`
- Spanish: `http://localhost:7777/es/blog/{slug}/`

Example: `http://localhost:7777/blog/demo-hero-banner/`
