...
| `CONTACT_ALLOWED_ORIGINS` | Recommended in prod | Comma-separated Origins for CORS (e.g. `https://cabuya.org`). When empty, the Function reflects the request Origin — tighten for production. |
